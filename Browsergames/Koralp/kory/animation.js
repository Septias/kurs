...
let speedY=speedfactor*(borderY/borderX)
let colorspeed=2
let voidspeed=1
...
function draw() {
  ...
  if (positionX < borderX - borderdistance - sizeX - voidsize && positionY < borderdistance + 1 + voidsize) {positionX = positionX + speedX} //oben
  if (positionX > borderX - borderdistance - sizeX - 1 - voidsize && positionY < borderY - borderdistance - sizeY - voidsize)  {positionY = positionY + speedY} //rechts
  if (positionX > borderdistance + voidsize && positionY > borderY - borderdistance - sizeY - 1 - voidsize) {positionX = positionX - speedX} //unten
  if (positionX < borderdistance + 1 + voidsize && positionY > borderdistance + voidsize) {positionY = positionY - speedY} //links
  ...
  if (backgroundBLUE==bignegativenumber*bigpositivenumber) {offsetY = offsetY + 400 ; console.log(offsetY)}
